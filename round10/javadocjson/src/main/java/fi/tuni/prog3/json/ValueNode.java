...
public class ValueNode extends Node{
  ...
  */
  public double getNumber() {
    if(!isNumber()){
      throw new IllegalStateException("if the stored value is not a number.");
    }
    return (Double) value;
  }
  ...
  */
  public boolean getBoolean() {
    if(!isBoolean()){
      throw new IllegalStateException("if the stored value is not a boolean value.");
    }
  ...
  */
  public String getString() {
    if(!isString()){
      throw new IllegalStateException("if the stored value is not a string.");
    }
    return (String) value;
  }
  ...
  */
  public Object getNull() {
    if(!isNull()){
      throw new IllegalStateException("if the stored value is not null.");
    }
    return value;
  }
}
